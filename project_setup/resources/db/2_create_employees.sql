...
INSERT INTO `homit`.`users_employees`(id, user_email, first_name, password, role_id) VALUES (2, "driver1@homit.ca", "Chingiz", "$2a$10$4BrlOxtvG9GH7IVvUI27OuVFxQkjj6jV1PsGBBEUpM/YjAxOiVYle", 3);
INSERT INTO `homit`.`drivers`(employee_id) VALUES (2);
INSERT INTO `homit`.`users_employees`(id, user_email, first_name, password, role_id) VALUES (3, "driver2@homit.ca", "Zaman", "$2a$10$4BrlOxtvG9GH7IVvUI27OuVFxQkjj6jV1PsGBBEUpM/YjAxOiVYle", 3);
